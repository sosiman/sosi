...
// Función para imprimir o exportar resultados
function printResults() {
    window.print();
}

// Función para compartir resultados (si se implementa en el futuro)
function shareResults(score, total) {
    if (navigator.share) {
        navigator.share({
            title: 'Mis resultados del cuestionario AWS',
            text: `He completado el cuestionario sobre Fundamentos de Cloud AWS con una puntuación de ${score}/${total}!`,
            url: window.location.href
        });
    } else {
        // Fallback para navegadores que no soportan Web Share API
        const text = `He completado el cuestionario sobre Fundamentos de Cloud AWS con una puntuación de ${score}/${total}! ${window.location.href}`;
